<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="ThemeSelection.aspx.cs" Inherits="ThemeSelection" %>

<html lang="zxx">

<head>
    <title>Virual Brush  |Theme Selection</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ThemeSelection</li>
        </ol>
    </div>
            <div class="container py-xl-5 py-lg-3">
                <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Related Themes In Market</h3>
                <p class="title-para text-center mx-auto mb-sm-5 mb-4">
                </p></div>
                <br><br>
                <div class="container">
                    <table cellpadding="20px" style="width: 100%; height: 200px; border: 2px solid #000000">
                        <tr>
                            <td>Magneeto Theme</td>
                            <td align="right">
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-dark" OnClick="LinkButton1_Click" >View More</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>Glow Theme</td>
                            <td align="right">
                                <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-dark" OnClick="LinkButton2_Click">View More</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>Ceiling Theme</td>
                            <td align="right">
                                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-dark" OnClick="LinkButton3_Click">View More</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
