<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="MagneetoTheme.aspx.cs" Inherits="MagneetoTheme" %>

<html lang="zxx">

<head>
    <title>Virual Brush  |Theme Selection::Magneeto Theme</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Magneeto Theme</li>
        </ol>
    </div>
            ...
            <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Related Magneeto Theme To Market</h3>
                <p class="title-para text-center mx-auto mb-sm-5 mb-4">All kids love playing different roles. It could be an astronaut or even a scuba diver. Here's a chance to give them a room that makes them feel like one! The magnetic wall themes from Virtual Brush is designed to let children bring their world to life, for real.
                </p>
        <br>
        <br>
        <div class="container">
            <h3><i class="fa fa-arrow-down"></i>&nbsp; Magneeto Theme</h3>
        ...
        <div class="container">
            <div class="row package-grids">
                <div class="blog-w3 col-lg-6  mb-3">
                    <div class="blogs-top">
                        <img src="images/fun-fair-magneeto-themes-500x500.png" alt="" class="img-fluid"  style="Height:300px;width:100%"/>
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Fun Fair</h4>

                    </div>
                </div>
                <div class="blog-w3 col-lg-6 mb-3">
                    <div class="blogs-top">
                        <img src="images/milky-way-magneeto-themes-500x500.png" alt="" class="img-fluid" style="Height:300px;width:100%" />
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Milky Way</h4>
            ...
            <div class="row package-grids">
                <div class="blog-w3 col-lg-6 mb-3">
                    <div class="blogs-top">
                        <img src="images/ocean-scape-magneeto-themes-500x500.png" alt="" class="img-fluid" style="Height:300px;width:100%" />
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Ocean Scape</h4>

                    </div>
                </div>
                <div class="blog-w3 col-lg-6 mb-3">
                    <div class="blogs-top">
                        <img src="images/slam-dunk-1.jpg.image.1140.597.medium.jpg" alt="" class="img-fluid" style="Height:300px;width:100%"/>
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Slam Dunk</h4>
