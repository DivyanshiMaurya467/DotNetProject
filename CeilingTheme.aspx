<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="CeilingTheme.aspx.cs" Inherits="CeilingTheme" %>

<html lang="zxx">

<head>
    <title>Virual Brush  |Theme Selection::Ceiling Theme</title>
    ...
    <form id="form1" runat="server">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Glow Theme</li>
                ...
                <p class="title-para text-center mx-auto mb-sm-5 mb-4">All kids love playing different roles. It could be an astronaut or even a scuba diver. Here's a chance to give them a room that makes them feel like one! The Ceiling wall themes from Virtual Brush is designed to let children bring their world to life, for real.
                </p>
        ...
        <br>
        <div class="container">
            <h3><i class="fa fa-arrow-down"></i>&nbsp; Ceiling Theme</h3>
        ...
        <div class="container">
            ...
            <div class="row package-grids">
                <div class="blog-w3 col-lg-6 mb-3">
                    <div class="blogs-top">
                        <img src="images/magic-mermaid-ceiling-themes-500x500.png"  style="Height:300px;width:100%"  />
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Magic Marmaid</h4>

                    </div>
                </div>
                <div class="blog-w3 col-lg-6 mb-3">
                    <div class="blogs-top">
                        <img src="images/space-zappers.jpg.image.360.319.medium.jpg" style="Height:300px;width:100%"/>
                    </div>
                    <div class="blogs-bottom p-4 bg-white ">
                        <h4 class="text-dark font-weight-bold mb-3">Space Zapper</h4>
