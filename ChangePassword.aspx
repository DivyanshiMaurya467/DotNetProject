<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="ChangePassword" %>

<html lang="zxx">

<head>
    <title>Virual Brush  | Change Password</title>
...
<body>
    ...
    <div class="contact py-5">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Change Password</h3>
            <div class="row contact-form">
                <div class="col-lg-7 wthree-form-left">
                    <div class="contact-top1">
                        <h1 class="mb-4 text-capitalize text-dark text-center">Fill Your New Password Info</h1>
                        <form runat="server" action="#" method="get" class="contact-wthree">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter Password..." required="" TextMode="password"></asp:TextBox>
                            </div>
                            <div class="form-group d-flex">
                                <label>
                                    <i class="fa fa-lock" aria-hidden="true"></i>
                                </label>
                                <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Enter Conform Password..." required="" TextMode="password" ValidationGroup="1" ></asp:TextBox>
                            </div>
                             
                            <div class="d-flex ">
                                <asp:Button ID="Button2" runat="server" Text="Submit" class="btn text-white btn-block btn-primary" OnClick="button1_Click" Width="100px" />
                            </div>
                ...
                <div class="col-lg-5 wthree-form-right">
                    <img src="images/changepassword.png" style="height:300px;width:350px"/>
                    </div>
