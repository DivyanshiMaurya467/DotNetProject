<%@ Page Title="" Language="C#" EnableEventValidation="false"  AutoEventWireup="true" CodeFile="Products.aspx.cs" Inherits="Products" %>

<html lang="zxx">
<head>
    <title>Virual Brush |Products</title>
...
<body>
    ...
    <form runat="server">
        <div class="blog-w3ls py-5 bg-light border-bottom" id="what">
            <div class="container ">
                <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Related Products In Market</h3>
                ...
                <div class="row package-grids">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                ...
                                <div class="col-md-3 blog-w3 border-info mb-3 ">
                                    <div class="blogs-bottom p-3 bg-white text-center">
                                        <div class="blogs-top">
                                            <img src='<%# Eval("Pro_Pic") %>' alt="" class="img-fluid" height="80" width="200px" />
                                        </div>
                                        <h4 class="text-dark font-weight-bold mb-3"><%# Eval("Pro_Name") %></h4>
                                        <h6 class="text-dark font-weight-bold mb-3"><i class="fa fa-rupee"></i><%# Eval("Price") %></h6>
                                        <i class="fa fa-paint-brush mr-2"></i><%# Eval("CName") %>
                                        <br />
                                        <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" CssClass="btn btn-info" CommandArgument='<%# Eval("Id") %>' Text="Add To Cart" />
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
