<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Contact" %>

<html lang="zxx">

<head>
    <title>Virual Brush  |Contacts</title>
...
<body>
    ...
    <div class="contact py-5">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Reviews and Feedbacks</h3>
            <div class="row contact-form">
                    ...
                    <div class="contact-top1">
                        ...
                        <form runat="server" action="#" method="get" class="contact-wthree">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Enter Email..." required="" TextMode="Email"></asp:TextBox>
                            </div>
                            <div class="form-group d-flex">
                                <label>
                                    <i class="fa fa-edit"></i>
                                </label>
                                <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="Enter Subject..." required=""></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="TextBox4" runat="server" class="form-control" placeholder="Enter Message..." required="" Rows="8" TextMode="MultiLine"></asp:TextBox>
                            </div>
                            <div class="d-flex  justify-content-end">
                                <asp:Button ID="Button1" runat="server" Text="Submit" class="btn text-white btn-block btn-primary w-25" OnClick="Button1_Click" />
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-5 wthree-form-right">
                    <br><br>
                    <img src="images/contact%20us.png" style="height:400px;width:350px"/>
                    </div>
            </div>
        </div>
    </div>
