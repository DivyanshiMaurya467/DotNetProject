<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="MediaGallery.aspx.cs" Inherits="MediaGallery" %>

<html lang="zxx">
<head>
    <title>Virual Brush | Media and Gallery</title>
...
<body>
    ...
    <div class="gallery pt-5">
        <div class="container pt-xl-5 pt-lg-3">
            <h3 class="title-w3 mb-sm-5 mb-4 text-dark text-center font-weight-bold">Media & Gallery</h3>
            ...
            <ul class="demo">
                <li>
                    <div class="gallery-grid1">
                        <img src="images/jjj.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/fun-fair-magneeto-themes-500x500.png" alt=" " class="img-fluid " style="height: 300px; width: 400px" />
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/k.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=3">
                            <div class="p-mask">
                                <h4>Virtual Brush</h4>
                            </div>
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/blog1.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=4">
                            <div class="p-mask">
                                <h4>Virtual Brush</h4>
                            </div>
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/ocean-scape-magneeto-themes-500x500.png" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=3">
                ...
                <li>
                    <div class="gallery-grid1">
                        ...
                        <img src="images/Plain Finisheed.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=4">
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/j.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=3">
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="images/Glaz-Faux.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=4">
                ...
                <li>
                    <div class="gallery-grid1">
                        <img src="DashBoard/ProPic/brushing.jpg" alt=" " class="img-fluid" style="height: 300px; width: 400px" />
                        <a href="Products.aspx?cid=3">
